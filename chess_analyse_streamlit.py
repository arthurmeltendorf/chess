    ...
    if st.button('Get Stats'):
        if username and password:
            ...
            with col1:
                ...
                ax1.set_title("Win/Loss", color='white', size=10)
            ...
            with col2:
                ...
                ax2.set_title('Accuracy per Game', color='white', size=10)
                ax2.set_xlabel('Accuracy', color='grey', size=6)
                ax2.set_ylabel('Frequency', color='grey', size=6)
                ax2.tick_params(colors='grey', labelsize=6)  
